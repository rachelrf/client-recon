...
module.exports.insertUser = function(user, salesId, callback){
  ...
  console.log('query string is', queryString.insertUser);
	var queryParameters = [user.client_name, user.client_email, user.client_birthday, user.client_company, user.client_zipcode, user.client_title, user.client_image, user.client_interests]; // added last argument - RY
