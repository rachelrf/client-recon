...
// THIS METHOD INSERTS A FRIEND INTO THE FRIENDS TABLE.
// IT THEN ADDS THAT FRIEND, AND THE USER ASSOCIATED WITH IT, 
// INTO A JOIN TABLE. 
exports.addOne = function (friend, userId, callback) {
...
// IF 'friendId' IS PROVIDED, IT WILL RETURN A SINGLE USER.
// IF NOT, IT WILL RETURN ALL FRIENDS
exports.getOne = function (friendId, userId, callback) {
  if (friendId === null) {
...
exports.updateOne = function (data, friendId, userId, callback) {
