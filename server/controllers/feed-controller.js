...
module.exports = {
  ...
  getSocialMedia: function(usernames, cb) {
    console.log('5. calling get social media results');
    socialMediaAggregator(usernames, function(result) {
      console.log('6. social media results: ', results);
      cb(result);
    });
  },
